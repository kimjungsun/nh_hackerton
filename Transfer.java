...
public class Transfer {
    public static <JSONObject> String Transfer(int tuno_val,String fin_acno) throws Exception {

        try {
            URL url = new URL("https://developers.nonghyup.com/DrawingTransfer.nh");
